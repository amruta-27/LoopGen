    ...
    try {
        ...
        if (userMessageCount >= 20) {
            return res.status(400).json({
                ...
                message: "This conversation has reached the maximum of 20 messages. Please start a new chat."
            });
        }
        ...
        const history = await Message.find({ conversationId: cid }).sort({ createdAt: 1 });
...
module.exports = { getChatResponse, createConversation, getAllConversations, getMessagesForConversation, deleteConversation };